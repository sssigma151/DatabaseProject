    ...
    <table>
        ...
        if ($run2->num_rows>0){
            while ($row=$run2->fetch_assoc()){
                echo "<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>".$row["price"]."</td><td>".$row["food_details"]."</td><td> <div class=\"w3-container\">"."<a href=\"menu_update.php\"class=\"w3-btn w3-orange\" name=\"view\">"."Update"."</td><td> <div class=\"w3-container\">"."<a href=\"logout.php\"class=\"w3-btn w3-orange\" name=\"view\">"."Delete"."</a> </div></td></tr>";
