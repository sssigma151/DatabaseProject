...
<header>
    <div class="main">
        ...
        <ul>
            <li> <a href="logout1.php">Home</a></li>
            <li> <a href="#">contact us</a></li>
            <li> <a href="fav.php" >Favourite items</a></li>
    ...
    if(isset($_POST['sear'])){
        ...
        if ($run1->num_rows>0){
            while ($row=$run1->fetch_assoc()){
                echo "<tr><td>".$row["name"]."</td><td>".$row["rating"]."</td><td>".$row["details"]."</td> <td>"." <div class=\"w3-container\">"."<a href=\"logout1.php\"class=\"w3-btn w3-orange\" name=\"viewmenu\">"."view Details"."</a> </div>"."</td></tr>";
